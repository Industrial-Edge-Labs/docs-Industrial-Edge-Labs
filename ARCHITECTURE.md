...
- **[`multi-physics-simulation-and-control-system`](https://github.com/Industrial-Edge-Labs/multi-physics-simulation-and-control-system)**: Portable plant simulator that consumes canonical FSM state, advances an RK4 model, and emits deterministic local telemetry. Node-specific documentation: [multi-physics-simulation-and-control-system/architecture.md](./multi-physics-simulation-and-control-system/architecture.md).
